...
unsigned int __builtin_stdc_bit_width();
unsigned int __builtin_stdc_count_ones();
unsigned int __builtin_stdc_count_zeros();
unsigned int __builtin_stdc_first_leading_one();
unsigned int __builtin_stdc_first_leading_zero();
unsigned int __builtin_stdc_first_trailing_one();
unsigned int __builtin_stdc_first_trailing_zero();
unsigned int __builtin_stdc_has_single_bit();
unsigned int __builtin_stdc_leading_ones();
unsigned int __builtin_stdc_leading_zeros();
unsigned int __builtin_stdc_trailing_ones();
unsigned int __builtin_stdc_trailing_zeros();
